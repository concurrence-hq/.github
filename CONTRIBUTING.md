...
For a code change, follow the target repository's contributor guide and run its named build, type, test, and packaging checks. State which checks used fixtures and which used a provisioned environment. Include compatibility and upgrade guidance when a public contract changes. Keep unrelated changes in separate PRs.
